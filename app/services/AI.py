...
class AI:
    ...
    @classmethod
    def json_to_embeddings(cls, json_data: List[dict], batch_size: int = 100) -> Generator[Tuple[List, List], None, None]:
    ...
    @classmethod
    def upsert_vectordb(cls, json_data: List[dict], batch_size: int = 100):
        successful = True
